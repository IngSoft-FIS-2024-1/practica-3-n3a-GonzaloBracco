...
describe('Library', () => {
  ...
  it('return the total number of books', () => {
    myLibrary.addBook('Cuentos de la Selva', 'Horacio Quiroga', 120,1200);
    myLibrary.addBook('El Hombre que Calculaba', 'Malba Tahan', 286,2860);
  ...
  it('throw an error when setting an empty name', () => {
    expect(() => myLibrary.addBook('', 'Horacio Quiroga', 120)).toThrow();
  });

  it('throw an error when name an empty name', () => {
  ...
  it('return the total number of words', () => {
    myLibrary.addBook('Cuentos de la Selva', 'Horacio Quiroga', 120,1200);
    myLibrary.addBook('El Hombre que Calculaba', 'Malba Tahan', 286,2860);
    expect(myLibrary.totalWords()).toBe(4060);
  });
